...
public class RestClientUtil {
    public void getFotografoByIdDemo() {
        ...
        ResponseEntity<Fotografo> responseEntity = restTemplate.exchange(url, HttpMethod.GET, requestEntity,
                Fotografo.class, 1);
        Fotografo Fotografo = responseEntity.getBody();
        System.out.println("Id:" + Fotografo.getId() + ", Title:" + Fotografo.getNome() + ", Category:");
    }
